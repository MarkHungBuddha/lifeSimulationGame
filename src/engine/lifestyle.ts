...
export const LIFESTYLE_PRESETS: Record<Exclude<LifestyleId, 'custom'>, LifestylePreset> = {
  frugal: {
    ...
    allocation: { sp500: 0.40, intlStock: 0.10, bond: 0.20, gold: 0.10, cash: 0.20, reits: 0 },
  },
  ...
  moderate: {
    ...
    allocation: { sp500: 0.45, intlStock: 0.15, bond: 0.20, gold: 0.10, cash: 0.10, reits: 0 },
  },
  ...
  comfortable: {
    ...
    allocation: { sp500: 0.40, intlStock: 0.15, bond: 0.25, gold: 0.05, cash: 0.15, reits: 0 },
  },
  ...
  lavish: {
    ...
    allocation: { sp500: 0.55, intlStock: 0.15, bond: 0.10, gold: 0.05, cash: 0.15, reits: 0 },
  },
  ...
  fire_lean: {
    ...
    allocation: { sp500: 0.60, intlStock: 0.20, bond: 0.10, gold: 0.05, cash: 0.05, reits: 0 },
  },
  ...
  fire_fat: {
    ...
    withdrawal: { type: 'fixed_amount', amount: 80000 },
    allocation: { sp500: 0.45, intlStock: 0.20, bond: 0.15, gold: 0.10, cash: 0.10, reits: 0 },
  },
}
