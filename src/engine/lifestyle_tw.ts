...
export const LIFESTYLE_PRESETS_TW: Record<Exclude<LifestyleId, 'custom'>, LifestylePreset> = {
  frugal: {
    ...
    allocation: { sp500: 0.35, intlStock: 0.15, bond: 0.20, gold: 0.10, cash: 0.20, reits: 0 },
  },
  ...
  moderate: {
    ...
    allocation: { sp500: 0.40, intlStock: 0.20, bond: 0.20, gold: 0.10, cash: 0.10, reits: 0 },
  },
  ...
  comfortable: {
    ...
    allocation: { sp500: 0.35, intlStock: 0.20, bond: 0.25, gold: 0.05, cash: 0.15, reits: 0 },
  },
  ...
  lavish: {
    ...
    allocation: { sp500: 0.50, intlStock: 0.20, bond: 0.10, gold: 0.05, cash: 0.15, reits: 0 },
  },
  ...
  fire_lean: {
    ...
    allocation: { sp500: 0.30, intlStock: 0.50, bond: 0.10, gold: 0.05, cash: 0.05, reits: 0 },
  },
  ...
  fire_fat: {
    ...
    allocation: { sp500: 0.30, intlStock: 0.35, bond: 0.15, gold: 0.10, cash: 0.10, reits: 0 },
  },
}
